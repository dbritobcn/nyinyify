...
const nyinyify_1 = require("./nyinyify");
describe("Nyinyify", () => {
    describe("Validate", () => {
        it("should validate successfully", () => {
            expect(() => new nyinyify_1.Nyinyify('Hello world').validate().value).not.toThrow();
        });
        it("should throw on empty sentence", () => {
            expect(() => new nyinyify_1.Nyinyify('').validate().value).toThrow();
        });
    });
    describe("Code", () => {
        it("should code simple lowercase sentence", () => {
            ...
            expect(new nyinyify_1.Nyinyify(sentence).code().value).toBe(expected);
        });
    ...
    describe("Decode", () => {
        it("should denokiafy simple sentences successfully", () => {
            ...
            expect(new nyinyify_1.Nyinyify(code).decode().value).toBe(expected);
        });
    ...
    describe("Convert", () => {
        it("should convert successfully", () => {
            ...
            expect(nyinyify_1.Nyinyify.convert(sentence)).toBe(expected);
        });
        it("should throw on empty sentence", () => {
            expect(() => nyinyify_1.Nyinyify.convert('')).toThrowError("Sentence is required");
        });
    });
});
